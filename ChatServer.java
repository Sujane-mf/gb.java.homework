...
public class ChatServer implements Server {
    ...
    public static String outputFileName = "history.txt";
    ...
    public void chatLog(String message) {
        ...
        BufferedWriter writeChatHistory = null;
        try {
            writeChatHistory = new BufferedWriter(new FileWriter(outputFileName, true));
            writeChatHistory.newLine();
            writeChatHistory.write(message);
            writeChatHistory.flush();
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
